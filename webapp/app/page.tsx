    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-100 flex flex-col items-center justify-center">
      <div className="max-w-xl w-full px-6 py-12 bg-white/80 rounded-xl shadow-xl flex flex-col items-center gap-8">
        ...
        <nav className="w-full flex flex-col gap-4">
          <Link
            href="/data"
            className="block w-full rounded-lg bg-blue-600 text-white text-lg font-semibold py-4 text-center shadow hover:bg-blue-700 transition"
          >
            Browse Data
          </Link>
          <Link
            href="/admin"
            className="block w-full rounded-lg bg-slate-800 text-white text-lg font-semibold py-4 text-center shadow hover:bg-slate-900 transition"
          >
            Admin Panel
          </Link>
          <Link
            href="/charcreate"
            className="block w-full rounded-lg bg-gradient-to-r from-green-500 to-blue-500 text-white text-lg font-semibold py-4 text-center shadow hover:from-green-600 hover:to-blue-600 transition"
          >
            Character Creator
          </Link>
        </nav>
